...
const AddBlog = () => {
 ...
 return (
  ...
  <p className='mt-4'>Blog Title</p>
    <input type='text' placeholder='Type here' value={title} required className='w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none' onChange={(e) => setTitle(e.target.value)} />

  <p className='mt-4'>Sub Title</p>
    <input type='text' placeholder='Type here' value={subTitle} required className='w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none' onChange={(e) => setSubTitle(e.target.value)} />
...
<button disable={isAdding} type='submit' className='mt-8 w-40 h-10 bg-primary text-white rounded cursor-pointer text-sm'>
