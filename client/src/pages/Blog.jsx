...
const Blog = () => {
  ...
  return data ? (
    // FIX: Wrap the main content div and the Footer inside a single root element (React.Fragment here)
    <> 
      <div className='relative'>
        ...
        <div className='text-center mt-20 text-gray-600'>
          ...
          <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Shreya Anumod</p>
          <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6 text-left'>
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              <form onSubmit={addComment} className='flex flex-col gap-4 items-start max-w-lg'>
                {/* Corrected name input to use 'name' state */}
